...
create table T_GENERIC_PARAMETER (id bigint generated by default as identity (start with 1), keyParameter varchar(255) not null, valueParameter varchar(255) not null, primary key (id))

...
create table T_LEG (id bigint generated by default as identity (start with 1), destination_id bigint not null, origin_id bigint not null, route_id bigint not null, primary key (id))

create table regionextension_actual_products (regionextension_id bigint not null, product_id bigint not null)
...
alter table regionextension_actual_products add constraint UK_mpys3cpabldk68av4viv2cw5a unique (product_id)
...
alter table regionextension_actual_products add constraint regionextension_actual_products_product_fk foreign key (product_id) references T_PRODUCT
alter table regionextension_actual_products add constraint regionextension_actual_products_regionextension_fk foreign key (regionextension_id) references T_REGION_EXTENSION
